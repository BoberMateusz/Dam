...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 7404082103151403379),
    name: 'Category',
    lastPropertyId: const obx_int.IdUid(2, 2159848837705044495),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 7853116368869975342),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 2159848837705044495),
        name: 'name',
        type: 9,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(2, 6018176592653360098),
    name: 'Task',
    lastPropertyId: const obx_int.IdUid(4, 3789517647740367845),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 5756443490393141096),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 2501553379604431890),
        name: 'name',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 2085944507752532026),
        name: 'isCompleted',
        type: 1,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 3789517647740367845),
        name: 'categoryId',
        type: 11,
        flags: 520,
        indexId: const obx_int.IdUid(1, 2534229154779784291),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(2, 6018176592653360098),
    lastIndexId: const obx_int.IdUid(1, 2534229154779784291),
